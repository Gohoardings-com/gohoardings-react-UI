...
const ForgetPass = ({
  ...
  // const Completionist = ({completed}) => <span className="text-success">Resend OTP</span>;
  ...
  //     return <span className="text-info" >{minutes}:{seconds}</span>;
  //   }
  // };
  ...
  return (
    <>
      <div className="modal-heading mt-3 text-center">
        <h1 className="modal-title">Did you forget your password ?</h1>
        <a className="forgetpass mt-2 me-4" onClick={() => goBack()}>
        ...
        <div className="forget-content animate__animated  animate__fadeIn">
          <form onSubmit={changePassword} novalidate>
            <div className="input-box">
              <label className="input-label">Create new password</label>
              <input
                type="text"
                className="input-1"

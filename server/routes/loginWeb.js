...
const { register, login, getuser,  googleLogin, logout, Profile, refreshToken, sendPasswordEmail, resetPasswordEmail, changepasswoed, imageupload, updateProfile } = require('../controller/REGISTERlOGIN');
